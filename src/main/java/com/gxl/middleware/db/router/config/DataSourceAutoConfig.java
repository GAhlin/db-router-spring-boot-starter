package com.gxl.middleware.db.router.config;

import com.gxl.middleware.db.router.DBRouterConfig;
import com.gxl.middleware.db.router.DBRouterJoinPoint;
import com.gxl.middleware.db.router.dynamic.DynamicDataSource;
import com.gxl.middleware.db.router.dynamic.DynamicMybatisPlugin;
import com.gxl.middleware.db.router.strategy.IDBRouterStrategy;
import com.gxl.middleware.db.router.strategy.impl.DBRouterStrategyHashCode;
import com.gxl.middleware.db.router.util.PropertyUtil;
import com.gxl.middleware.db.router.util.StringUtils;
